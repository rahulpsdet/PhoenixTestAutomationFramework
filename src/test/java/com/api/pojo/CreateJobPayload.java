...
public class CreateJobPayload {
	...
	private CustomerAdress customer_address;
	...
	public CreateJobPayload(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id,
			int mst_oem_id, Customer customer, CustomerAdress customer_address, CustomerProduct customer_product,
			Problems[] problems) {
		super();
	...
	public CustomerAdress getCustomer_address() {
		return customer_address;
	}
	public void setCustomer_address(CustomerAdress customer_address) {
		this.customer_address = customer_address;
	}
